...
%{--        todo: 2 refactor duplicated parts into template--}%
        ...
        <div>
          ...
          <input type="number decimal" name="en" value="${calculatorInstance.getProperty('en')}"
                 ...
                 class="${hasError(calculatorInstance, 'en') ? 'error' : ''}" %{-- wird nicht gefunden, da die Idee ist, das in ein Template auszulagern (in dem Template ist dann ein entsprechender Import zu FieldUtil --}%
